...
class knowledgedisplay extends StatefulWidget {
  const knowledgedisplay({Key? key}) : super(key: key);

  @override
  State<knowledgedisplay> createState() => _knowledgedisplayState();
}
...
class _knowledgedisplayState extends State<knowledgedisplay> {
  ...
  Future<List<Question>> getData() async {
    return know.knowfetchQuestions();
  }

  // final result = Get.find<ResultController>();
