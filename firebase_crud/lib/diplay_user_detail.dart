...
import 'package:firebase_crud/update_user_details.dart';
...
//     debugPrint('Removing user with $id');
//     return users
//         .doc(id)
//         .delete()
//         .then((value) => Get.snackbar('Delete', 'User Deleted with $id'))
//         .catchError((onError) =>
//             Get.snackbar('Error', 'Error while removing $onError'));
//   }
