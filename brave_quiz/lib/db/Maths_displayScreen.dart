...
class mathsdisplay extends StatefulWidget {
  const mathsdisplay({Key? key}) : super(key: key);

  @override
  State<mathsdisplay> createState() => _mathsdisplayState();
}

class _mathsdisplayState extends State<mathsdisplay> {
  var maths = MathsDbconnect();
  late Future _questions;
  Future<List<Question>> getData() async {
    return maths.mathsfetchQuestions();
  }
